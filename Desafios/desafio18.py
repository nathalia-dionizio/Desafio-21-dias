...
currency_from = input("Insira a moeda de origem: ")
currency_to = input("Insira a moeda de destino: ")

converted_value = c.convert(value, currency_from, currency_to)

print(f'{value} {currency_from} = {converted_value} {currency_to}')
